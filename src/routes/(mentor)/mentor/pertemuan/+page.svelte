<script lang="ts">
	...
	function openEditForm(meeting: MeetingItem) {
		...
		formSessionDate = meeting.sessionDate;
		formStartTime = meeting.startTime;
		formEndTime = meeting.endTime;
		formLocation = meeting.location ?? '';
		formMaterialUrl = meeting.materialUrl ?? '';
		formIsWeekend = meeting.isWeekend;
		formHasTask = false;
		formTaskTitle = '';
		formTaskDescription = '';
		formTaskSize = 'sedang';
...
<div class="content-area">
	...
	<div class="page-header-row">
		...
		<div class="header-actions">
			<button type="button" onclick={openCreateForm} class="btn-create">
